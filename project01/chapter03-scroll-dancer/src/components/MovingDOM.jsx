...
export const MovingDOM = () => {
  ...
  useFrame(() => {
    ...
    article01Ref.current.style.opacity = `${1 - scroll.range(0, 1 / 8)}`; //시작점, 이동거리
  ...
  return (
    <Scroll html>
      <ArticleWrapper ref={article01Ref}>
        <LeftBox>
          <span>FastCmapus Interactive Web Lecture</span>
          <span>FastCmapus Interactive Web Lecture</span>
          <span>FastCmapus Interactive Web Lecture</span>
          <span>FastCmapus Interactive Web Lecture</span>
          <span>FastCmapus Interactive Web Lecture</span>
      ...
      <ArticleWrapper ref={article02Ref}>
        <RightBox>
          <span>FastCmapus Interactive Web Lecture Right</span>
          <span>FastCmapus Interactive Web Lecture Right</span>
          <span>FastCmapus Interactive Web Lecture Right</span>
          <span>FastCmapus Interactive Web Lecture Right</span>
          <span>FastCmapus Interactive Web Lecture Right</span>
      ...
      <ArticleWrapper className="height-4" ref={article04Ref}>
        <RightBox>
          <span>FastCmapus Interactive Web Lecture Right AGAIN</span>
          <span>FastCmapus Interactive Web Lecture Right AGAIN</span>
          <span>FastCmapus Interactive Web Lecture Right AGAIN</span>
          <span>FastCmapus Interactive Web Lecture Right AGAIN</span>
          <span>FastCmapus Interactive Web Lecture Right AGAIN</span>
      ...
      <ArticleWrapper ref={article08Ref}>
        {"WOW!!"}
        <Footer>
          {"What should I writting something here..?? anyway THIS is FOOTER"}
        </Footer>
      </ArticleWrapper>
    </Scroll>
  );
